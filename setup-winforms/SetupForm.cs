...
namespace ChatGPTFixSetup
{
    public class SetupForm : Form
    {
        ...
        public SetupForm()
        {
            ...
            _cancel = new Button { Text = "取消", Left = 280, Top = 200, Width = 90, Height = 30 };
        ...
        private bool DoInstall()
        {
            try
            {
                ...
                string installRoot = Environment.ExpandEnvironmentVariables(LocalAppData);
        ...
        {
            string lnkDir = Environment.GetFolderPath(Environment.SpecialFolder.StartMenu) + "\\Programs";
